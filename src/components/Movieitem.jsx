...
//         if (doc.exists) {
//           // If likedMovies document exists for the user
//           const currentLikes = doc.data().movies || []; // Fetch current liked movies
//           const updatedLikes = [...currentLikes]; // Copy current likes to update

//           if (!like) {
//             // If not already liked, add to liked movies
//             updatedLikes.push({ title, image }); // Customize this structure as per your database schema
//           } else {
//             // If already liked, remove from liked movies
...
//           // Update liked movies in Firestore
//           await likedMoviesRef.set({ movies: updatedLikes });
//           setLike(!like); // Toggle like state in UI
//         } else {
//           // If the document doesn't exist, create a new one
//           await likedMoviesRef.set({ movies: [{ title, image }] });
//           setLike(true); // Set like to true in UI
//         }
//       } else {
...
//       <img
//         className='object-cover h-40 block w-full object-top'
//         src={createimage('original', image ?? altimg)}
//         alt={title}
//       />
